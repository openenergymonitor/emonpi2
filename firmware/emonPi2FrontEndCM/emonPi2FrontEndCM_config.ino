...
static void list_calibration(void)
{
  ...
  Serial.print(F("|i3Cal: ")); Serial.print(EEProm.i3Cal);
  Serial.print(F(", Lead: ")); Serial.println(EEProm.i3Lead);
...
static void report_calibration(void)
{
  ...
  Serial.print(F(" k3 ")); Serial.print(EEProm.i3Cal); Serial.print(F(" ")); Serial.print(EEProm.i3Lead);
        ...
        case 'k':
          ...
          */
          ...
          switch (k1) {
            ...
            case 3 : EmonLibCM_ReCalibrate_IChannel(2, k2, k3);
              EEProm.i3Cal = k2;
              EEProm.i3Lead = k3;
              break;
